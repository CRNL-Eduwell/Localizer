...
namespace Algorithm
{
	...
	{
	public:
		static void ExecuteAlgorithm(Algorithm::Strategy::AlgorithmType algo, eegContainer* EegContainer, int IndexFrequencyData, const std::vector<int>& FrequencyBand);
